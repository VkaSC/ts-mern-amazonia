...
import { Navbar, Container, Nav, Button, NavDropdown, NavbarCollapse, Form, InputGroup, FormControl } from 'react-bootstrap'
        ...
        <Navbar
          ...
          <div className="d-flex justify-content-between align-items-center">
            <LinkContainer to='/' className='header-link'>
              <Navbar.Brand>VCE Art World</Navbar.Brand>
            </LinkContainer>
            <Form className='flex-grow-1 d-flex me-auto'>
              <InputGroup>
                <FormControl
                  ...
                  name='q'
                  id='q'
                  placeholder='Buscar en VCE'
                  aria-label='Buscar en VCE'
